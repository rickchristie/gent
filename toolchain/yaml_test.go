...
func TestYAML_AvailableToolsPrompt_Policy(t *testing.T) {
	type mockTool struct {
		name        string
		description string
		policy      string
...
func TestYAML_Execute_TracesToolCallErrors(t *testing.T) {
...
func TestYAML_Execute_TracesToolCallErrors_UnknownTool(t *testing.T) {
	t.Run("unknown tool increments error counters", func(t *testing.T) {
		tc := NewYAML()
...
func TestYAML_Execute_TracesToolCallErrors_SchemaValidation(t *testing.T) {
	t.Run("schema validation error increments error counters", func(t *testing.T) {
		tc := NewYAML()
		tool := gent.NewToolFunc(
			"validated_tool",
