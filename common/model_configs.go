...
// ConfigRegistry is the list of tested configurations. Each config references a model from
// ModelRegistry and describes how to use it. One model can have multiple configs (e.g.,
// nomic at full 768d and truncated 384d Matryoshka).
//
...
var ConfigRegistry = []ModelConfig{
	...
	{
		ModelName: "multilingual-e5-small", ConfigName: "multilingual-e5-small",
		Description: "Default. Best quality/size for multilingual.",
		Dimensions: 384, Pooling: PoolingMean, MaxSeqLen: 512,
	...
	{
		ModelName: "multilingual-e5-base", ConfigName: "multilingual-e5-base",
		Description: "Higher quality multilingual. 2x memory vs e5-small.",
		Dimensions: 768, Pooling: PoolingMean, MaxSeqLen: 512,
		QueryPrefix: "query: ", PassagePrefix: "passage: ",
	...
	// --- e5-small-v2 ---
	{
		ModelName: "e5-small-v2", ConfigName: "e5-small-v2",
	...
	// --- all-MiniLM-L6-v2 ---
	{
		ModelName: "all-MiniLM-L6-v2", ConfigName: "all-MiniLM-L6-v2",
		Description: "Most widely used small model. No prefixes needed.",
		Dimensions: 384, Pooling: PoolingMean, MaxSeqLen: 256,
	...
	// --- bge-small-en-v1.5 ---
	{
		ModelName: "bge-small-en-v1.5", ConfigName: "bge-small-en-v1.5",
		Description: "Strong small English retrieval. CLS pooling.",
		Dimensions: 384, Pooling: PoolingCLS, MaxSeqLen: 512,
	...
	// --- bge-base-en-v1.5 ---
	{
		ModelName: "bge-base-en-v1.5", ConfigName: "bge-base-en-v1.5",
		Description: "Strong base English retrieval. CLS pooling.",
		Dimensions: 768, Pooling: PoolingCLS, MaxSeqLen: 512,
		QueryPrefix:   "Represent this sentence for searching relevant passages: ",
		PassagePrefix: "",
		InputNames: []string{"input_ids", "attention_mask"},
		OutputName: "token_embeddings",
	...
	{
		ModelName: "nomic-embed-text-v1.5", ConfigName: "nomic-embed-text-v1.5-768d",
		Description: "Full 768 dimensions. Best for long documents (8192 seq len).",
		Dimensions: 768, Pooling: PoolingMean, MaxSeqLen: 8192,
	...
	{
		ModelName: "nomic-embed-text-v1.5", ConfigName: "nomic-embed-text-v1.5-384d",
		Description: "Matryoshka 384d truncation. Same model, half the vector storage.",
		Dimensions: 384, ModelDimensions: 768, Pooling: PoolingMean, MaxSeqLen: 8192,
		QueryPrefix: "search_query: ", PassagePrefix: "search_document: ",
		InputNames: []string{"input_ids", "token_type_ids", "attention_mask"},
		OutputName: "last_hidden_state",
	...
	{
		ModelName: "snowflake-arctic-embed-s", ConfigName: "snowflake-arctic-embed-s",
	...
	{
		ModelName: "snowflake-arctic-embed-m", ConfigName: "snowflake-arctic-embed-m",
	...
	// --- bge-micro-v2 ---
	{
		ModelName: "bge-micro-v2", ConfigName: "bge-micro-v2",
